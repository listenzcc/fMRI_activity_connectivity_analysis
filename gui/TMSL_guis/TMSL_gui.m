function varargout = TMSL_gui(varargin)
% TMSL_gui MATLAB code for TMSL_gui.fig
%      TMSL_gui, by itself, creates a new TMSL_gui or raises the existing
%      singleton*.
%
%      H = TMSL_gui returns the handle to a new TMSL_gui or the handle to
%      the existing singleton*.
%
%      TMSL_gui('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TMSL_gui.M with the given input arguments.
%
%      TMSL_gui('Property','Value',...) creates a new TMSL_gui or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before TMSL_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to TMSL_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help TMSL_gui
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @TMSL_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @TMSL_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before TMSL_gui is made visible.
function TMSL_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to TMSL_gui (see VARARGIN)

% Choose default command line output for TMSL_gui
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes TMSL_gui wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = TMSL_gui_OutputFcn(hObject, eventdata, handles) 
